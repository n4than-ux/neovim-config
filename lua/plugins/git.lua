		...
		keys = {
			{
				...
				desc = "Toggle live blame (gitsigns)",
			},
			{
				"<leader>gd",
				function()
			...
			},
			{
				...
				desc = "Preview Hunk Inline (Gitsigns)",
			},
			-- navigation
			{
				"[[",
				...
				{ desc = "Toggle Next Hunk", buffer = "bufnr" },
			},
			{
				"]]",
				function()
				...
				{ desc = "Toggle Previous Hunk", buffer = "bufnr" },
			},
		},
	},
}
